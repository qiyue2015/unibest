...
export const getViewerList = () => {
  return http.get<IViewer[]>('/app/index.php?a=wxapp&c=entry&m=basketball&do=viewer&op=list')
}

export const saveViewer = (data: IViewer) => {
  return http.post<IViewer>('/app/index.php?a=wxapp&c=entry&m=basketball&do=viewer&op=save', data)
}
